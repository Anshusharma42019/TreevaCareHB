...
router
  ...
  .get(auth('admin', 'manager', 'sales', 'support', 'logistics', 'doctor', 'staff'), departmentFilter, validate(leadValidation.getLeads), leadController.getLeads);
...
router.get('/search-phone', auth('admin', 'manager', 'sales', 'support', 'logistics', 'doctor', 'staff'), departmentFilter, leadController.searchByPhone);
router.get('/follow-up/list', auth('admin', 'manager', 'sales', 'support', 'logistics', 'doctor', 'staff'), departmentFilter, leadController.getFollowUpLeads);
...
router
  .route('/:leadId')
  .get(auth('admin', 'manager', 'sales', 'support', 'logistics', 'doctor', 'staff'), departmentFilter, validate(leadValidation.getLead), leadController.getLead)
